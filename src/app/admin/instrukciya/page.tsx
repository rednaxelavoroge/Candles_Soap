...
const CHAPTERS = [
  ...
  { id: "sohranit", num: "05", title: "Что происходит после «Сохранить»" },
  { id: "melochi", num: "06", title: "Мелочи, которые стоит знать" },
];
  ...
  return (
    <div className="min-h-screen bg-bg">
      <div className="mx-auto flex max-w-2xl flex-col gap-12 px-5 py-12 md:px-8 md:py-16">
        ...
        <Chapter id="sohranit" num="05" title="Что происходит после «Сохранить»">
          <p className="text-[0.95rem] leading-relaxed text-ink">
        ...
        <Chapter id="melochi" num="06" title="Мелочи, которые стоит знать">
          <Bullets
            items={[
              <>
              ...
              <>Ломать панель, нажимая не туда, у вас не получится. Любую правку можно отменить.</>,
            ]}
          />
        </Chapter>
