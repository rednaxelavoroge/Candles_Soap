      ...
      <div className="mx-auto flex max-w-2xl flex-col gap-12 px-5 py-12 md:px-8 md:py-16">
        ...
        <Chapter id="poryadok" num="05" title="Порядок: что за чем стоит">
          ...
          <p className="mt-3 text-[0.95rem] leading-relaxed text-ink">
            Стрелки <Btn>↑</Btn> <Btn>↓</Btn> никуда не делись и работают как раньше.
            Они нужны на телефоне: там перетаскивания нет — палец прокручивает
            страницу, а не переносит карточку.
          </p>
          <Bullets
            items={[
              <>
              ...
              <>
                ...
                Внутри карточки: тащите снимок мышью, на телефоне — стрелки{" "}
                <Btn>←</Btn> <Btn>→</Btn> под ним. Первый помечен словом «Обложка» —
                именно он показывается в каталоге.
              </>,
              <>
